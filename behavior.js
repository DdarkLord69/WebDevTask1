...
function showScore() {
    ...
    document.getElementById("Score").innerHTML = "Your Time is " + seconds + "." + ms;
    showHS();
}
...
function showHS() {
    document.getElementById("hs1").innerHTML = (highScores[0] == undefined) ? " " : highScores[0];
    document.getElementById("hs2").innerHTML = (highScores[1] == undefined) ? " " : highScores[1];
    document.getElementById("hs3").innerHTML = (highScores[2] == undefined) ? " " : highScores[2];
    document.getElementById("hs4").innerHTML = (highScores[3] == undefined) ? " " : highScores[3];
    document.getElementById("hs5").innerHTML = (highScores[4] == undefined) ? " " : highScores[4];
}
